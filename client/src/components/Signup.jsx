  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-500">
      <div className="bg-white p-8 rounded shadow-md w-full md:w-96">
        <h2 className="text-4xl font-bold mb-4 text-center text-orange-600">Signup</h2>
        <form className="space-y-4">
          ...
          <button
            ...
            className="bg-orange-500 text-white px-4 py-2 rounded hover:bg-green-600 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-200"
          >
            Signup
          </button>
        </form>
